...
(function() {
    ...
    if (typeof window !== 'undefined') {
        FleetboLogger.info("FleetboSystem instance created but not exposed globally for security.");
    } else {
        console.warn("FleetboSystem is running in a non-browser environment.");
    }
...
const Fleetbo = {
  ...
  onWebPageReady: (route, navbarState) => command("onWebPageReady", route, navbarState),
...
window.Fleetbo = Fleetbo;
initializeFleetbo().catch(err => {
    console.error("Fleetbo automatic initialization failed:", err.message);
});
// eslint-disable-next-line no-unused-vars
